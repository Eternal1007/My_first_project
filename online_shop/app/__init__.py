...
def create_app():
    ...
    _ensure_columns(db_path, 'products', {'created_at': 'DATETIME','updated_at': 'DATETIME','description': 'TEXT','stock': 'INTEGER','is_active': 'BOOLEAN','category': 'TEXT','rating': 'FLOAT','sale': 'BOOLEAN'})
